...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('assets/images/22.png') }}" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('assets/images/22.png') }}"
                alt=""></a>
    </div>
    <!-- Top bar left -->
    ...
    <ul class="nav navbar-nav ml-auto">
        <ul>
            ...
            <li class="page-item">
                <a class="page-item" rel="alternate" hreflang="{{ $localeCode }}"
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{ route('login') }}"><i class="text-danger ti-unlock"></i>Logout</a>
            </div>
        </li>
    </ul>
</nav>
